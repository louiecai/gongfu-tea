...
const EN = {
  ...
  rinseLabel: "Rinse",
  startRinse: "Start rinse",
  skipRinse: "Skip rinse",
  popOutTimer: "Pop out timer",
  strengthChip: (x: string) => `strength ×${x}`,
  brewStyleGongfu: "Gongfu",
  brewStyleWestern: "Western",
  vesselLabel: "Vessel",
  ...
  noHistoryYet: "No brews logged yet.",
  historyBrewCount: (n: number) => `${n} brew${n === 1 ? "" : "s"} logged`,
  historyLastBrewed: (date: string) => `last brewed ${date}`,
  historyAvgRating: (x: string) => `avg ${x}★`,
  historyBestBrew: (grams: string, temp: number) =>
    `Best brew: ${grams} g · ${temp}°C`,
  ...
  fHasRinse: "Rinse first (short flash steep before steeping)",
  ...
  logEntryEyebrow: "记 · brew details",
  sessionNotFound: "This session was removed.",
  backToLog: "Back to log",
  deleteSessionConfirm: "Delete this session? This can't be undone.",
  statsSessions: "Sessions",
  statsSteeps: "Steeps poured",
  statsLeaf: "Leaf used",
  statsStreak: "Day streak",
  statsAvg: "Avg brew",
  statsFavorite: "Favorite tea",
  heatmapTitle: "Brewing activity",
  logSearchPlaceholder: "Search sessions…",
  sortNewest: "Newest first",
  sortRating: "Highest rated",
  sortLongest: "Longest brewed",
  ...
  chimeStyleBell: "Bell",
  chimeStyleWood: "Wood",
  chimeStyleBright: "Bright",
  previewChime: "Preview",
  ...
  vesselProfilesSection: "Your vessels",
  vesselNamePlaceholder: "e.g. Gaiwan",
  addVessel: "Add",
  ...
  profilesSection: "Backup & restore",
  ...
  progressTitle: (tea: string) => `${tea} is steeping`,
  progressBody: (mmss: string) => `${mmss} left`,
  announceTenSeconds: "10 seconds left",
  announceSteepDone: "Steep done",
};
...
const ZH: typeof EN = {
  ...
  yourHistory: "冲泡记录",
  noHistoryYet: "还没有泡过这款茶。",
  historyBrewCount: (n) => `已泡 ${n} 次`,
  historyLastBrewed: (date) => `最近一次 ${date}`,
  historyAvgRating: (x) => `平均 ${x}★`,
  historyBestBrew: (grams, temp) => `最佳一泡：${grams} 克 · ${temp}°C`,
  ...
  resumeSession: "继续",
  brewAgain: "再泡一次",
  logEntryEyebrow: "记 · 冲泡详情",
  sessionNotFound: "该记录已被删除。",
  backToLog: "返回记录",
  deleteSessionConfirm: "删除这条记录？此操作无法撤销。",
  statsSessions: "泡茶次数",
  statsSteeps: "共泡次数",
  statsLeaf: "用茶量",
  statsStreak: "连续天数",
  ...
  vesselProfilesSection: "我的茶具",
  vesselNamePlaceholder: "例如：盖碗",
  addVessel: "添加",
  ...
  steepDoneBody: "该出汤了 🫖",
  progressTitle: (tea) => `${tea} 正在冲泡`,
  progressBody: (mmss) => `还剩 ${mmss}`,
  announceTenSeconds: "还剩 10 秒",
  announceSteepDone: "这一泡好了",
};
